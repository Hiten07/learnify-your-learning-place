...
const ProgressBar = ({ progress, color = '#4CAF50', height = '20px' }) => {
  ...
  return (
    <div className="w-80 mx-auto select-none font-sans">
      ...
      >
        <span className="font-semibold text-gray-700">See Course Progress ⬇️</span>
      ...
      {isOpen && (
        <div className="mt-8 px-4 pb-8 bg-white rounded-b-md shadow-md border border-t-0 border-gray-200">
          ...
          <p className="text-gray-700 mb-3">
            Completed <span className="font-semibold">{progress.completedLessons}</span> out of{' '}
            <span className="font-semibold">{progress.totallessons}</span> lessons
          </p>
